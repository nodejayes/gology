...
func TestNewCoordinate(t *testing.T) {
	...
	coord2d := NewCoordinate(1.0, 2.0, math.Inf(-1), 4326)
	...
	coord3d := NewCoordinate(1.0, 2.0, 3.0, 4326)
...
func TestCoordinate_CompareTo(t *testing.T) {
	...
	coord1 := NewCoordinate(1.5, 2.5, 3.5, 4326)
	coord2 := NewCoordinate(1.5, 2.5, 3.5, 4326)
	coord3 := NewCoordinate(1.0, 2.0, 3.5, 4326)
	coord4 := NewCoordinate(2.0, 3.0, 4.5, 4326)
	coord5 := NewCoordinate(1.5, 1.5, 4.5, 4326)
	coord6 := NewCoordinate(1.5, 2.5, 4.5, 4326)
	coord7 := NewCoordinate(1.5, 3.0, 4.5, 4326)
...
func TestCoordinate_GetterSetter(t *testing.T) {
	t.Parallel()
	g := gomega.NewGomegaWithT(t)
	coord := NewCoordinate(1.5, 2.5, 3.5, 4326)
	...
	g.Expect(coord.GetSrID()).To(gomega.Equal(4326))
	...
	g.Expect(coord.GetDimension()).To(gomega.Equal(DDD))
	g.Expect(coord.GetSrID()).To(gomega.Equal(3876))
...
func TestCoordinate_TakeOverCoordinate(t *testing.T) {
	...
	coord.TakeOverCoordinate(NewCoordinate(15.5, 15.5, math.Inf(-1), 4326))
	g.Expect(coord.GetX()).To(gomega.Equal(15.5))
	g.Expect(coord.GetY()).To(gomega.Equal(15.5))
	g.Expect(coord.GetDimension()).To(gomega.Equal(DD))
}
...
func TestCoordinate_Distance(t *testing.T) {
	t.Parallel()
	g := gomega.NewGomegaWithT(t)
	coord1 := NewCoordinate(0.0, 0.0, 0.0, 4326)
	coord2 := NewCoordinate(1.0, 0.0, 0.0, 4326)
	coord3 := NewCoordinate(1.0, 1.0, 0.0, 4326)

	coord4 := NewCoordinate(5.5, 4.8, math.Inf(-1), 4326)
	coord5 := NewCoordinate(15.5, 2.789, math.Inf(-1), 4326)
...
func TestCoordinate_Equals(t *testing.T) {
	...
	coord1 := NewCoordinate(1.5, 2.5, 3.5, 4326)
	coord2 := NewCoordinate(1.5, 2.5, 3.5, 4326)
	coord3 := NewCoordinate(1.4, 2.5, 3.5, 4326)
...
func TestCoordinate_EqualsTolerance(t *testing.T) {
	...
	coord2 := NewCoordinate(1.5, 2.5, 3.5, 4326)
	coord3 := NewCoordinate(1.4, 2.5, 3.5, 4326)
	coord4 := NewCoordinate(1.41, 2.5, 3.5, 4326)
...
func TestCoordinate_Equals2D(t *testing.T) {
	...
	coord1 := NewCoordinate(1.5, 2.5, 3.5, 4326)
	coord2 := NewCoordinate(1.5, 2.5, 3.5, 4326)
	coord3 := NewCoordinate(1.5, 2.5, 4.5, 4326)
	coord4 := NewCoordinate(1.4, 2.5, 4.5, 4326)
...
func TestCoordinate_Equals2DTolerance(t *testing.T) {
	...
	g := gomega.NewGomegaWithT(t)
	coord1 := NewCoordinate(1.5, 2.5, 3.5, 4326)
	coord2 := NewCoordinate(1.4, 2.5, 3.5, 4326)
	coord3 := NewCoordinate(1.41, 2.5, 3.5, 4326)
...
func TestCoordinate_ToString(t *testing.T) {
	...
	coordInf := NewCoordinate(1.5, 2.5, math.Inf(-1), 4326)
